        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    ...
                    <input name="edit-config" type="submit" value="Eidt" class="button-primary"/>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td> <fieldset><legend class="hidden">Color Schema</legend>
                    <p>Back Color: <input type="text" id="backcolor" name="player-config[backcolor]" value="<?php echo "#" . substr($configs['backcolor'],2); ?>" size="8" /><div id="backcolorpicker"></div>
                    <br/><small>Notice:When you set the background image, this will not work.</small>
                    </p>
                    <p>Front Color: <input type="text" id="frontcolor" name="player-config[frontcolor]" value="<?php echo "#" . substr($configs['frontcolor'],2); ?>" size="8" /><div id="frontcolorpicker"></div></p>
                    <p>Light Color: <input type="text" id="lightcolor" name="player-config[lightcolor]" value="<?php echo "#" . substr($configs['lightcolor'],2); ?>" size="8" /><div id="lightcolorpicker"></div></p>
                </fieldset></td>
            </tr>
